        ...
        <div class="bg-gray-100">
            <div class="">
                <div x-data="{ open: false }" class="relative overflow-hidden bg-sky-700 pb-32">
                    <nav class="bg-transparent relative z-10 border-b border-teal-500 border-opacity-25 lg:border-none lg:bg-transparent" :class="{ 'bg-sky-900': open, 'bg-transparent': !(open) }">
                    ...
                    <header v-if="$slots.header" class="relative py-10">
